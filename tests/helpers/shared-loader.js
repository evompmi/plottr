// Loads `_core/shared.ts` into a Node vm context so its pure functions
// can be unit-tested. Browser-only functions (flashSaved, downloadSvg,
// downloadCsv) are excluded from the exports here because they require
