...
export default {
  ...
  mutate: [
    // Initial scope: volcano only — the deepest-property-covered
    // helpers file in the repo (57 properties + ~40 unit tests). Once
    // the workflow proves out, widen incrementally:
