...
const fr: Record<ShellKey, string> = {
  ...
  "shell.color.swatch": "{label}, couleur",
  "shell.color.hex": "{label}, valeur hexadécimale",
  "shell.color.swatchGeneric": "Couleur",
  "shell.color.hexGeneric": "Valeur hexadécimale de la couleur",
