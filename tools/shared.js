...
const TOOL_ICONS = {
  ...
  // Volcano: a two-cloud splay — vermillion dots top-right (up-regulated),
  // deep-blue dots top-left (down-regulated), grey ns cluster centre-bottom,
  // dashed p-cutoff guide. Covers the visual identity of the tool in 12
  // shapes; intentionally readable at 22 px landing-tile size.
  volcano:
    '<svg viewBox="0 0 44 44" fill="none"><line x1="3" y1="26" x2="41" y2="26" stroke="#999999" stroke-width="0.8" stroke-dasharray="2,2" opacity="0.55"/><circle cx="22" cy="34" r="1.8" fill="#999999"/><circle cx="18" cy="32" r="1.5" fill="#999999"/><circle cx="26" cy="36" r="1.5" fill="#999999"/><circle cx="14" cy="36" r="1.4" fill="#999999"/><circle cx="30" cy="32" r="1.5" fill="#999999"/><circle cx="22" cy="38" r="1.4" fill="#999999"/><circle cx="8" cy="22" r="2" fill="#0072B2"/><circle cx="6" cy="14" r="2.4" fill="#0072B2"/><circle cx="12" cy="10" r="2.2" fill="#0072B2"/><circle cx="36" cy="22" r="2" fill="#D55E00"/><circle cx="38" cy="14" r="2.4" fill="#D55E00"/><circle cx="32" cy="10" r="2.2" fill="#D55E00"/></svg>',
};
