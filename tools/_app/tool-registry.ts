...
//
// The 10 imports below pull each tool's `App` from its `app.tsx`
// sibling (the result of the phase-2 split — see
// `tools/boxplot/index.tsx` for the rationale). esbuild's
// `--bundle` flag inlines all of them into the single SPA build
// produced from `tools/_app/index.tsx`.

import { App as BoxplotApp } from "../boxplot/app";
import { App as ScatterApp } from "../scatter/app";
import { App as VennApp } from "../venn/app";
import { App as UpsetApp } from "../upset/app";
import { App as LineplotApp } from "../lineplot/app";
