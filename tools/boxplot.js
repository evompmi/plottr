...
function UploadStep({ sepOverride, onSepChange, rawText, doParse, handleFileLoad, setStep }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    ...
    { icon: "\u{1F3A8}", text: "Plot: choose box, violin, or raincloud style. Color-by, facet-by, jitter controls, and SVG download." }
  ...
  ].map(({ step, text }) => /* @__PURE__ */ React.createElement("div", { key: step, style: { display: "flex", gap: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#E07B39", flexShrink: 0 } }, step), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444", lineHeight: 1.55 } }, text)))), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 10, color: "#888", marginTop: 8, marginBottom: 0, lineHeight: 1.5 } }, "Each slice is colored to match the jitter points. Percentage labels are shown for categories \u2265 8 % of the pie. Useful for quickly spotting unbalanced group compositions (e.g. sex ratio across genotypes).")), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 10, padding: "14px 18px", border: "1.5px solid #b0c4ff", gridColumn: "1/-1" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: "#7c3aed", marginBottom: 10, textTransform: "uppercase", letterSpacing: "1px" } }, "\u{1F3BB} Plot Styles"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#555", marginBottom: 8, lineHeight: 1.6 } }, "Use the ", /* @__PURE__ */ React.createElement("strong", null, "Plot style"), " dropdown in the style controls to switch between three visualization modes:"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 5 } }, [
    { step: "Box", text: "Classic box-and-whisker plot. Median line, IQR box, 1.5\xD7IQR whiskers, outlier dots." },
  ...
  ].map(({ step, text }) => /* @__PURE__ */ React.createElement("div", { key: step, style: { display: "flex", gap: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#7c3aed", flexShrink: 0, minWidth: 52 } }, step), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444", lineHeight: 1.55 } }, text)))), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 10, color: "#888", marginTop: 8, marginBottom: 0, lineHeight: 1.5 } }, "All styles support color-by, facet-by, and outlier dots. The Y-axis auto-adjusts to fit the violin/raincloud density curves.")), /* @__PURE__ */ React.createElement("div", { style: { borderLeft: "4px solid #648FFF", background: "#dbeafe", padding: "10px 14px", borderRadius: "0 8px 8px 0", gridColumn: "1/-1" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: "#3b6cf7" } }, "\u{1F4A1} Tip \u2014 "), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "#444" } }, "Wide-format files (like the output of the Bar Graph or Aequorin tools) are auto-detected and go straight to plot. For long-format, you can facet by one column while coloring points by another.")), /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1/-1", display: "flex", gap: 6, flexWrap: "wrap" } }, ["Separator explicitly selected (comma, semicolon, tab, space)", "Quoted values stripped automatically", "100% browser-side \u2014 nothing uploaded"].map((t) => /* @__PURE__ */ React.createElement("span", { key: t, style: { fontSize: 10, padding: "3px 10px", borderRadius: 20, background: "#fff", border: "1px solid #b0c4ff", color: "#555" } }, t))))));
}
