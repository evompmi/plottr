...
export interface UploadStepProps {
  ...
  // Format (wide / long) is owned by the parent App internally — set by
  // `doParse` on auto-detect or by the cross-tool handoff payload — and
  // intentionally not surfaced as an upload-step user choice.
