...
const { useMemo, useEffect, forwardRef, memo } = React;

const VW = 600,
  VH = 500;

export const VennChart = memo(
  forwardRef<SVGSVGElement, VennChartProps>(function VennChart(
    {
      setNames,
      sets,
      intersections,
    ...
    const blend =
      readabilityBlend != null ? readabilityBlend : VENN_CONFIG.DEFAULT_READABILITY_BLEND;
