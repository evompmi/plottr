...
const fr: Record<LineplotKey, string> = {
  ...
  "lineplot.groups.lineStyleAria": "Style de ligne pour {name}",
  "lineplot.groups.pointShapeAria": "Forme de point pour {name}",
  "lineplot.groups.filled": "Marqueur plein — cliquer pour ouvert",
  "lineplot.groups.open": "Marqueur ouvert — cliquer pour plein",
  "lineplot.lineStyle.solid": "Plein",
  "lineplot.lineStyle.dashed": "Tirets",
  "lineplot.lineStyle.dotted": "Pointillés",
  "lineplot.pointShape.circle": "Cercle",
  "lineplot.pointShape.square": "Carré",
  "lineplot.pointShape.triangle": "Triangle",
  "lineplot.pointShape.diamond": "Losange",
