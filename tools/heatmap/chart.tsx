...
export const HeatmapChart = memo(
  forwardRef<SVGSVGElement, HeatmapChartProps>(function HeatmapChart(
    {
      rowLabels,
      colLabels,
      matrix,
    ...
    return (
      <div ref={wrapperRef} style={{ position: "relative" }}>
        ...
        >
          ...
          {(showKmeansStrip != null ? showKmeansStrip : showClusterStrip) &&
